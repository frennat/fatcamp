...
**Sep 13, later:** TikTok live at tiktok.com/@fatcamp.ai (photo, bio, username set). Higgsfield TikTok publisher connected (OAuth granted). Reel 1 v2 is uploaded to Higgsfield storage and ready to publish; the publish call needs the tiktok_publish tools allowed in Claude Code permissions (auto-mode classifier blocks posting actions by default). TikTok bio link: personal accounts can't add a clickable link until 1k followers or a Business switch — keep sound access, revisit at 1k.
